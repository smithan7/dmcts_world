...
from custom_messages.srv import DMCTS_Travel_Goal
...
class PID_Controller(object):
  ...
  def init(self):
    ...
    self.goal_sub = rospy.Subscriber('/uav' + self.index + '/travel_goal', DMCTS_Travel_Goal, self.goal_callback )
  ...
  def goal_callback(self, g_in):
    self.goal_loc = np.array([g_in.x. g_in.y, 10.0, 0.0])
