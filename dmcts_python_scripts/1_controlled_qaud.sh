...
roslaunch hector_quadrotor_gazebo spawn_one_quadrotor.launch &
pid="$pid $!"
sleep 5s
...
roslaunch dmcts_world dmcts_world.launch num_agents:=1 num_nodes:=10 &
pid="$pid $!"
sleep 5s

echo "launching quad_controllers 2"
roslaunch dmcts dmcts.launch num_agents:=1 num_nodes:=10 &
pid="$pid $!"
sleep 3s
